...
# 		echo ${mid} >> ./datas/singers.txt
# 	done
# 	((sin=sin+80))
# done

# singermids=$(cat './datas/singers.txt' | grep -o '00[a-zA-Z0-9]\{12\}')
...
# 		echo ${songmid} >> ./datas/songs.txt
# 	done
# done

songmids=$(cat './datas/songs.txt' | grep -o '00[a-zA-Z0-9]\{12\}')
for songmid in ${songmids[@]}; do
